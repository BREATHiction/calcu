...
function calculateLongTerm() {
    ...
    const LE = parseFloat(document.getElementById('exposureDuration').value);
    const EF = 365;
...
document.getElementById('results').innerHTML = ` 
    <div class="result-item"><strong>Inhalation Exposure Dose:</strong> ${Iinh} µg/kg/yr</div>
    <div class="result-item"><strong>Hazard Quotient based on the World Health Organization of the Philippines:</strong> 
        <span style="color: ${rqData.color};">${RQ} - ${rqData.label}</span>
    </div>
    <div class="result-item"><strong>Hazard Quotient based on the guidelines of the United States Environmental Protection Agency:</strong> 
...
document.getElementById('results').innerHTML = ` 
    <strong>Individual Exposure Dose:</strong> ${Iexposure} µg/kg/hr
    <div class="result-item"><strong>Hazard Quotient based on the World Health Organization of the Philippines:</strong> 
        <span style="color: ${rqData.color};">${RQ} - ${rqData.label}</span>
    </div>
    <div class="result-item"><strong>Hazard Quotient based on the guidelines of the United States Environmental Protection Agency:</strong> 
